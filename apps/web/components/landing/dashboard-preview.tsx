          ...
          <div className="flex-1 space-y-8 w-full">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground md:text-lg leading-relaxed max-w-[600px]">
                Monitor real-time inference telemetry. Our command center provides detailed
                transparency into the segmentation masks, confidence thresholds, and derived
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="border bg-background p-5 flex flex-col gap-2">
                ...
                <span className="text-3xl font-bold text-primary">
                  87<span className="text-base font-normal text-muted-foreground ml-2">/ 100</span>
                </span>
              </div>
            </div>
          </div>
