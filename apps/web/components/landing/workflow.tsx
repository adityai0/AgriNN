  ...
  const steps = [
    {
      title: 'Upload Image',
      icon: ImagePlus,
      description: 'Ingest visual data via API or interface.',
    },
    {
      title: 'Animal Detection',
      icon: ScanLine,
      description: 'YOLO26 bounding box and segmentation.',
    },
    {
      title: 'Morphological Analysis',
      icon: Ruler,
      description: 'Extract skeletal parameters with OpenCV.',
    },
    {
      title: 'ATC Score Generation',
      icon: ClipboardCheck,
      description: 'Calculate standardized traits.',
    },
    {
      title: 'Structured Records',
      icon: Database,
      description: 'Export metrics to central database.',
    },
  ];
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col items-center justify-center space-y-4 text-center mb-16">
          ...
          <p className="max-w-[700px] text-muted-foreground md:text-lg">
            A deterministic multi-stage computer vision workflow designed for minimal latency and
            high accuracy.
          </p>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-start justify-between relative">
          ...
          {steps.map((step, index) => (
            <div
              key={index}
              className="flex flex-col items-center flex-1 w-full mb-12 md:mb-0 px-2 text-center group"
            >
