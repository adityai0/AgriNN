      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid gap-16 lg:grid-cols-2 items-center">
          <div className="space-y-6 border p-8 bg-card">
            <h2 className="text-2xl font-bold tracking-tighter md:text-3xl">The Constraint of Manual Scoring</h2>
          ...
          <div className="space-y-6">
            <h2 className="text-3xl font-bold tracking-tighter md:text-4xl">Computer Vision Architecture</h2>
            <p className="text-muted-foreground md:text-lg leading-relaxed">
