    ...
    <div className="p-6 md:p-10 space-y-8 max-w-4xl mx-auto">
      ...
      <div className="space-y-6">
        <div className="border bg-card p-6 space-y-4">
           ...
           <div className="space-y-4">
             ...
             <div className="flex flex-col space-y-1">
               ...
               <input type="number" defaultValue="85" className="bg-background border p-2 text-sm w-full max-w-sm" />
             </div>
           </div>
        ...
        <div className="border bg-card p-6 space-y-4">
           ...
           <p className="text-sm text-muted-foreground">Irreversible actions that affect your stored analysis data.</p>
