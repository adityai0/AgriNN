      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="h-[300px] w-full">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={data}>
                ...
                <Tooltip cursor={{ fill: '#f3f4f6' }} contentStyle={{ borderRadius: 0, border: '1px solid #e5e7eb', boxShadow: 'none' }} />
        ...
        <div className="border bg-card p-6 flex flex-col space-y-6">
          <div className="space-y-1">
             ...
             <p className="text-sm text-muted-foreground">Aggregated scoring metrics over the last 30 days.</p>
          </div>
